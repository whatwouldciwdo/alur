...
async function main() {
  ...
  const upsertSys = async (data: {
    ...
    emailPerusahaan: string; tlGroup?: string;
  }) => {
  ...
  await prisma.user.upsert({
    ...
    update: { nip: "TL_SHIFT_A", nama: "Ihwansyah WS.", jenjangJabatan: "Officer/TL Shift A", role: "TL", tlGroup: "A" },
    create: {
      nip: "TL_SHIFT_A",
      nama: "Ihwansyah WS.",
  ...
  await prisma.user.upsert({
    ...
    update: { nip: "TL_SHIFT_B", nama: "Untung Riyadi", jenjangJabatan: "Officer/TL Shift B", role: "TL", tlGroup: "B" },
    create: {
      nip: "TL_SHIFT_B",
      nama: "Untung Riyadi",
  ...
  await prisma.user.upsert({
    ...
    update: { nip: "TL_SHIFT_C", nama: "Sulistiyono", jenjangJabatan: "Officer/TL Shift C", role: "TL", tlGroup: "C" },
    create: {
      nip: "TL_SHIFT_C",
      nama: "Sulistiyono",
  ...
  await prisma.user.upsert({
    ...
    update: { nip: "TL_SHIFT_D", nama: "Yayan Suryana", jenjangJabatan: "Officer/TL Shift D", role: "TL", tlGroup: "D" },
    create: {
      nip: "TL_SHIFT_D",
      nama: "Yayan Suryana",
  ...
  await prisma.user.upsert({
    ...
    update: { nip: "ASM_SHIFT", nama: "M. Ulil Amri", jenjangJabatan: "Asman Operasi", role: "ASMAN" },
    create: {
      nip: "ASM_SHIFT",
      nama: "M. Ulil Amri",
  ...
  const pegawaiList: PegawaiInput[] = [
    ...
    { nip: "1778258308", nama: "Ahmad Yani", jenjangJabatan: "Pelaksana K3 (Non Shift)", bidang: "OPERASI", subBidang: "K3", emailPerusahaan: "ahmad.yani@plnipservices.co.id", emailPersonal: "iancampoes@gmail.com", phone: "081932167177" },
